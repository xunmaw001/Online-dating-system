<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消息" prop="xiaoxi">
          <el-input v-model="ruleForm.xiaoxi" 
              placeholder="消息" clearable  :readonly="ro.xiaoxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消息" prop="xiaoxi">
              <el-input v-model="ruleForm.xiaoxi" 
                placeholder="消息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发信人账号" prop="faxinrenzhanghao">
          <el-input v-model="ruleForm.faxinrenzhanghao" 
              placeholder="发信人账号" clearable  :readonly="ro.faxinrenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发信人账号" prop="faxinrenzhanghao">
              <el-input v-model="ruleForm.faxinrenzhanghao" 
                placeholder="发信人账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发信人姓名" prop="faxinrenxingming">
          <el-input v-model="ruleForm.faxinrenxingming" 
              placeholder="发信人姓名" clearable  :readonly="ro.faxinrenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发信人姓名" prop="faxinrenxingming">
              <el-input v-model="ruleForm.faxinrenxingming" 
                placeholder="发信人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	xiaoxi : false,
	fasongshijian : false,
	faxinrenzhanghao : false,
	faxinrenxingming : false,
	userid : false,
      },
      ruleForm: {
        zhanghao: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fasongshijian = true;
          ...
          if(o=='faxinrenzhanghao'){
            this.ruleForm.faxinrenzhanghao = obj[o];
	    this.ro.faxinrenzhanghao = true;
            continue;
          }
          if(o=='faxinrenxingming'){
            this.ruleForm.faxinrenxingming = obj[o];
	    this.ro.faxinrenxingming = true;
            continue;
          }
          if(o=='userid'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huifu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huifuCrossAddOrUpdateFlag = false;
                  this.parent.search();
