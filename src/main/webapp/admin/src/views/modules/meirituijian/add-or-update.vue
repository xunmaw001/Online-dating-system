<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="内心独白" prop="neixindubai">
          <el-input v-model="ruleForm.neixindubai" 
              placeholder="内心独白" clearable  :readonly="ro.neixindubai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="内心独白" prop="neixindubai">
              <el-input v-model="ruleForm.neixindubai" 
                placeholder="内心独白" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="兴趣爱好" prop="xingquaihao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xingquaihao" label="兴趣爱好" prop="xingquaihao">
                    <span v-html="ruleForm.xingquaihao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="个人相册" prop="gerenxiangce">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gerenxiangce" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gerenxiangce" label="个人相册" prop="gerenxiangce">
                    <span v-html="ruleForm.gerenxiangce"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nianling = true;
          ...
          if(o=='neixindubai'){
            this.ruleForm.neixindubai = obj[o];
	    this.ro.neixindubai = true;
            continue;
          }
          if(o=='xingquaihao'){
	    ...
	    this.ro.xingquaihao = true;
          ...
          if(o=='gerenxiangce'){
            this.ruleForm.gerenxiangce = obj[o];
	    this.ro.gerenxiangce = true;
            continue;
          }
          if(o=='touxiang'){
	...
	this.ruleForm.xingquaihao = this.ruleForm.xingquaihao.replace(reg,'../../../ssmm78s3/upload');
	this.ruleForm.gerenxiangce = this.ruleForm.gerenxiangce.replace(reg,'../../../ssmm78s3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `meirituijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.meirituijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
